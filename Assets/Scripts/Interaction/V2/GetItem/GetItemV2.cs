...
public class GetItemV2 : MonoBehaviour
{
    ...
    private void PegarObjeto(GetItemObjectV2 obj)
    {
        ...
        if (logarEventos)
            MiniMarketUpgradeLogger.Log("GetItemV2", "Objeto pego", pegando.name, "getitem-v2-pick-" + pegando.name, 0.5f);
    }
    ...
    public void SoltarObjeto()
    {
        ...
        if (logarEventos)
            MiniMarketUpgradeLogger.Log("GetItemV2", "Objeto solto", nome, "getitem-v2-release-" + nome, 0.5f);
    }
