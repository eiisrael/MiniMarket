...
public class PlayerDatabase : MonoBehaviour
{
    ...
    /// </summary>
    public static PlayerDatabase ObterOuCriar()
    {
        if (Instance != null)
            return Instance;
    ...
    private MiniMarketPlayerData CarregarDoDisco()
    {
        try
        {
            ...
            {
                if (logarEventos)
                    Debug.Log("[PlayerDatabase] Banco nao encontrado. Criando dados novos.");
        ...
        {
            Debug.LogWarning("[PlayerDatabase] Falha ao carregar banco. Um novo banco sera criado. Motivo: " + ex.Message);
    ...
    {
        GarantirCarregado();
        Debug.Log("[PlayerDatabase] Caminho do banco: " + caminhoBanco);
    }
