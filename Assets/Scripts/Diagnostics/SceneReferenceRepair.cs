...
public class SceneReferenceRepair : MonoBehaviour
{
    [Header("Ativação")]
    ...
    private static SceneReferenceRepair instancia;
    ...
    private static void CriarAutomaticamente()
    {
        ...
        instancia = go.AddComponent<SceneReferenceRepair>();
    }
    ...
    private void RepararAgora()
    {
        ...
        for (int i = 0; i < todos.Length; i++)
        {
            ...
            if (logarReparos)
            {
                ...
                Debug.Log("[SceneReferenceRepair] " + detalhes);
                UpgradeLogger.Log("Runtime", "Cross scene reference reparada", detalhes, "scene-ref-repair-" + root.name, 2f);
            }
        }
    }
